...
`].filter(Js).join(`
`)),o=Xl(o),o=lh(o,t),o=ch(o,t),a=Xl(a),a=lh(a,t),a=ch(a,t),o=uh(o),a=uh(a),t.isRawShaderMaterial!==!0&&(A=`#version 300 es
...
`)+`
`+p);const E=A+m+o,T=A+p+a,U=oh(s,s.VERTEX_SHADER,E),P=oh(s,s.FRAGMENT_SHADER,T);s.attachShader(x,U),s.attachShader(x,P),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function R(b){if(i.debug.checkShaderErrors){const K=s.getProgramInfoLog(x).trim(),q=s.getShaderInfoLog(U).trim(),ee=s.getShaderInfoLog(P).trim();let se=!0,X=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(se=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,U,P);else{const $=ah(s,U,"vertex"),k=ah(s,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
